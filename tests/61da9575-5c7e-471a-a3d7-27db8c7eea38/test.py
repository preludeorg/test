...
async def main():
    async with async_playwright() as p:
        for browser_type in [p.chromium, p.firefox, p.webkit]:
            ...
            await page.get_by_label("Username or email address").fill("lulztest")
            await page.get_by_label("Password").click()
            await page.get_by_label("Password").fill("t3sting1234554321@")
            ...
            await page.get_by_label("Repository name").fill("test3")
